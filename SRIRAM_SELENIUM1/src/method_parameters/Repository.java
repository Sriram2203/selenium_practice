...
public class Repository
{
	...
	public String driver_path="Browser_Drivers\\";
	...
	
{
		...
		//==================================================================================	
			...
			public void enter_text(By string,String inputdata)
			{
				WebElement Editbox=wait.until(ExpectedConditions.visibilityOfElementLocated(string));
				Editbox.clear();
